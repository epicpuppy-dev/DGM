...
execute positioned -898 41 -697 unless score active values matches 1 run team join blue @a[distance=..2]
execute positioned -886 41 -697 unless score active values matches 1 run team join red @a[distance=..2]
